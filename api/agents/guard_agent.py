...
class GuardAgent():
    ...
    def get_response(self, messages):
        ...
        # Prompt to detect any query that is not in the coffee shop data
        system_prompt = """ 
        ...
        3. Ask questions about internal finances, salaries, or business strategies. 
        4. Ask questions about personal data of the employees or owners.
        5. Demand medical advice about such an item. 
        ...
        }] + messages[-3:] # taking into account the last three messages
